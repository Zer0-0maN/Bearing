...
enumRotor = 4; % 0 для эллиптического подшипника с 100% массой;
               % 1 для эллиптического подшипника с 70% массой;
               % 2 для эллиптического подшипника с нулевой массой;
               % 3 для сегментного подшипника с 100% массой;
               % 4 для сегментного подшипника с 70% массой;
               % 5 для сегментного подшипника с нулевой массой;
...
%Решение уравнение
func = @(t, y) func_segment(t, y, Zborder/6,...
