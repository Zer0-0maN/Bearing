...
f = [x(2);x(3);
    ...
    -0.256*x(1)-0.355*Z*x(1)+0.882*x(4)-2.436*Z*x(4)-0.057*cos(314*t)+...
    +0.001*sin(314*t) + 0.0003*FPy(omega*t) - 0.017*FPx(omega*t);
    x(5);x(6);
    -0.106*x(3)-1.018*x(6)+0.052*x(2)-0.36*x(5)+0.051*Z*x(5)+...
    +0.097*Z*x(1)-0.045*x(1)-0.313*x(4)-0.078*Z*x(4)-0.001*cos(314*t)+...
    +0.008*sin(314*t) + 0.0003*FPx(omega*t) - 0.0024*FPy(omega*t);
